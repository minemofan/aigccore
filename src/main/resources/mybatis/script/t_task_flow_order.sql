...
(
    ...
    `ext_info`            varchar(2048) COLLATE utf8mb4_bin         DEFAULT NULL COMMENT '扩展信息',
    ...
    `run_rule`            varchar(64) COLLATE utf8mb4_bin  NOT NULL DEFAULT 'DEFAULT' COMMENT '运行模式TaskFlowRunRuleEnum',
    `run_rule_mode`       varchar(4096) COLLATE utf8mb4_bin         DEFAULT NULL COMMENT '运行规则TaskFlowRunRuleMode',
    ...
    `dt`                  varchar(128) COLLATE utf8mb4_bin          DEFAULT NULL COMMENT '依赖数据版本（用于支持重跑数据）',
    ...
    `chain_alias`         varchar(128) COLLATE utf8mb4_bin          DEFAULT NULL COMMENT '节点别名',
